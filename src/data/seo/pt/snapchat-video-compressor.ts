export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Por que usar o Compressor de Vídeos do Snapchat da SavClip"
  },
  {
    "type": "paragraph",
    "content": "Para quem valoriza cada detalhe, a resolução é o fator mais importante. Nosso baixador de vídeos em alta definição do Snapchat é a melhor opção para salvar mídias em qualidade original e assistir offline em qualquer tela."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  {
    "q": "Como baixar vídeos do Snapchat na resolução máxima?",
  ...
  },
  {
    ...
    "a": "Isso depende do arquivo original enviado para o Snapchat. Conseguimos extrair em Full HD (1080p), 2K ou até 4K se disponível."
  }
];

export const meta = {
  title: "Compressor de Vídeos Snapchat Sem Marca d'Água - SavClip",
  description: "Baixe vídeos HD e 4K do Snapchat com nosso mecanismo de elite. Preservamos a qualidade original e bitrates elevados sem nenhuma compressão."
};
...
export const header = {
  ...
  subtitle: "Baixe vídeos, reels e mídias do Snapchat na resolução original máxima em alta velocidade."
};
