export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Por que o SavClip é o melhor Baixador de Reels do Facebook?"
  },
  {
    "type": "paragraph",
...
export const faqs = [
  {
    "q": "Como baixar vídeos do Facebook em alta qualidade?",
    "a": "Copie o link do vídeo do Facebook, cole na barra de pesquisa no topo desta página e clique no botão de download para gerar os links de salvamento."
  },
  {
...
export const meta = {
  title: "Baixador de Reels Facebook Grátis e Rápido - SavClip",
  description: "Baixe vídeos do Facebook em alta definição (1080p, 4K) de forma rápida e simples. Nossa ferramenta online oferece a melhor velocidade de download sem anúncios intrusivos."
};
...
export const header = {
  ...
  title3: "Grátis em HD",
  subtitle: "Salve seus vídeos favoritos do Facebook em MP4 de alta resolução diretamente no seu aparelho."
};
