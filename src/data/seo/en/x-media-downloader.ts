export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Why SavClip is the Best X Media Downloader"
  },
  {
    "type": "paragraph",
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "How to Download Media from X (Twitter)"
  },
  {
    "type": "paragraph",
    "content": "SavClip makes obtaining X media files incredibly easy. You can download multiple attached files in just three simple steps:"
  },
  {
    "type": "list",
    "items": [
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "Download Twitter Photos in 4K Quality"
  },
  {
    "type": "paragraph",
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "Handle Mixed Media Posts Flawlessly"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "Security is our highest priority. To use our X media downloader, we do not require you to create an account, log in, or install any sketchy apps. The platform is completely anonymous and fully web-based, ensuring your privacy is protected."
  }
];

export const faqs = [
  {
    "q": "Can I download multiple photos from a single X post?",
    "a": "Yes! If a tweet contains up to 4 photos (a media grid), our tool will identify all of them and provide individual download links for each image."
  },
  {
  ...
  },
  {
    ...
    "a": "Yes. Our engine fetches the 'original' resolution file from X's servers, meaning you can often download images in 4K or their highest uploaded quality."
  },
  {
    "q": "Is it free to use the X Media Downloader?",
    "a": "Yes, SavClip's X Media Downloader is 100% free to use with no limits on how many posts you can process."
  },
  {
    "q": "Does this tool work for private X accounts?",
    "a": "No. Our tool can only fetch media from public X profiles. We cannot bypass privacy settings to access posts from locked accounts."
  }
];
...
export const header = {
  ...
  "title1": "Download",
  "title2": "Twitter Media",
  "title3": "Original HD",
  "subtitle": "Download all photos and videos from any X (Twitter) post in one place."
};
