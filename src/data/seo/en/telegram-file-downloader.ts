export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Why SavClip is the Best Telegram File Downloader"
  },
  {
    "type": "paragraph",
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "How to Download Files from Telegram"
  },
  {
    "type": "paragraph",
    "content": "SavClip makes obtaining Telegram documents incredibly easy. You can fetch and save any file type in just three simple steps:"
  },
  {
    "type": "list",
    "items": [
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "High-Speed Multi-Threaded Downloads"
  },
  {
    "type": "paragraph",
  ...
  },
  {
    "type": "heading",
    "level": 2,
    "content": "The Best Online TG Document Saver"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "Security is our highest priority. To use our Telegram file downloader, we do not require you to create an account or provide any login credentials. The platform is completely anonymous and fully web-based, ensuring you are protected from malware and tracking while you save your important documents."
  }
];

export const faqs = [
  {
    "q": "What is the maximum file size I can download?",
    "a": "Our tool is optimized to handle standard file sizes efficiently. For extremely large files (over 1GB), download times will depend on your local internet speed."
  },
  {
  ...
  {
    "q": "Is it free to use the Telegram File Downloader?",
    "a": "Absolutely. SavClip's Telegram file extraction tool is 100% free to use with no limits on how many files you can download."
  },
  {
    "q": "Do I need to install an app to download files?",
    "a": "No. SavClip is a fully browser-based utility. You can download any file type on any device directly through our website."
  }
];

export const meta = {
  "title": "Telegram File Downloader HD - Save Large Files Online - SavClip",
