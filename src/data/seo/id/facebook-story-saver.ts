export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Pengunduh Cerita Facebook dengan Anonimitas Total"
  },
  {
    "type": "paragraph",
    "content": "Story akan hilang setelah 24 jam, tetapi ada momen atau ide konten menarik yang ingin Anda simpan selamanya. Alat pengunduh Facebook kami memudahkan Anda menyimpan foto dan video secara instan dan aman."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "Hindari screenshot buram yang merusak kualitas gambar. Alat kami mengakses file asli dari server Facebook agar Anda mendapatkan file JPG (untuk foto) dan MP4 (untuk video) dengan resolusi dan ketajaman warna asli."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  ...
  },
  {
    ...
    "a": "Tidak, demi menghormati privasi pengguna, alat kami hanya bisa mengunduh konten dari akun Facebook publik."
  },
  {
...
export const meta = {
  title: "Penyimpan Cerita Facebook gratis online - SavClip",
  description: "Lihat dan unduh cerita serta sorotan Facebook secara anonim. Pemilik akun tidak akan pernah tahu Anda menyimpan foto atau video mereka."
};
...
export const header = {
  ...
  subtitle: "Simpan cerita, foto, dan sorotan sementara Facebook secara cepat dan anonim."
};
