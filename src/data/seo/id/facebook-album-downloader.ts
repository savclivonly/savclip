export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Mengapa menggunakan SavClip untuk proses Pengunduh Album Facebook?"
  },
  {
    "type": "paragraph",
    "content": "Alat kami mengambil file gambar resolusi tinggi langsung dari server. Dengan SavClip, Anda dapat menyimpan foto profil, foto postingan, dan korsel dengan kejernihan maksimal. Jika Anda ingin mencoba fitur lain, Anda juga dapat menggunakan <a href=\"/facebook-live-video-downloader\">Pengunduh Video Langsung</a> kami atau memeriksa <a href=\"/facebook-dp-downloader\">Pengunduh Foto Profil</a> untuk akses lengkap."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "Kami mendeteksi link asli file gambar di server Facebook, memastikan foto yang disimpan persis seperti yang diunggah pembuatnya."
  }
];
