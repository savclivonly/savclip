export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Cara SavClip Menyederhanakan Pengunduhan Media Sosial"
  },
  {
    "type": "paragraph",
...
export const faqs = [
  {
    "q": "Bagaimana cara mengunduh konten Media Sosial secara online?",
    "a": "Cukup salin link postingan dari Media Sosial, buka SavClip, tempel to kolom di atas, lalu klik tombol unduh."
  },
  {
    "q": "Apakah ada batas pengunduhan harian untuk Media Sosial?",
...
export const meta = {
  title: "Pengunduh Media Media Sosial gratis online - SavClip",
  description: "Download video, foto, dan musik dari Media Sosial gratis dengan kualitas terbaik. Layanan cepat, aman, dan tanpa iklan yang mengganggu."
};

export const header = {
  title: "Pengunduh Media",
  title1: "Download",
  title2: "Media Sosial Media",
  title3: "Online Gratis",
  subtitle: "Unduh konten Media Sosial dalam kualitas HD asli dengan cara yang sederhana dan aman."
};
