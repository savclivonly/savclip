export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من يوتيوب"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على يوتيوب لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "أداة فحص القيود الجغرافية يوتيوب مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط يوتيوب بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};

export const header = {
  title: "أداة فحص القيود الجغرافية",
  title1: "Download",
  title2: "يوتيوب القيود الجغرافية",
  title3: "أون لاين مجاناً",
  subtitle: "تحميل محتوى يوتيوب بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
