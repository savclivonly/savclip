export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل فيديوهات تليجرام بدون شعارات"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "بدلاً من قص أطراف الفيديو أو وضع تمويه يفسد جودة المظهر، تتصل أداتنا بملف الفيديو الأصلي على خوادم تليجرام قبل إضافة شعار التطبيق، لنمنحك مقطع فيديو نظيفاً تماماً."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  {
    "q": "كيف يمكنني حفظ فيديوهات تليجرام بدون علامة مائية؟",
    "a": "انسخ رابط الفيديو من تليجرام، ثم الصقه في صندوق البحث أعلاه واضغط على زر تحميل. ستقوم الأداة بإزالة العلامة المائية تلقائياً."
  },
  {
...
export const meta = {
  title: "تحميل ميديا تليجرام مجاناً وبجودة عالية - SavClip",
  description: "حمل فيديوهات وريلز تليجرام بدون علامة مائية أو شعارات مزعجة. احصل على مقطع فيديو نظيف بصيغة MP4 وبجودة عالية مع الصوت الأصلي."
};
...
export const header = {
  ...
  subtitle: "احفظ فيديوهات تليجرام بشكل نظيف وبدون أي شعارات مع الاحتفاظ بالصوت الأصلي."
};
