export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من شبكات التواصل الاجتماعي"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على شبكات التواصل الاجتماعي لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  {
    "q": "كيف يمكنني تنزيل محتوى شبكات التواصل الاجتماعي عبر الإنترنت؟",
    "a": "انسخ رابط المشاركة الخاص بالمنشور، ثم توجه إلى موقع SavClip والصق الرابط في الصندوق أعلاه واضغط على زر تحميل."
  },
  {
    "q": "هل هناك حد يومي لعدد التنزيلات من شبكات التواصل الاجتماعي؟",
...
export const meta = {
  title: "تحميل ميديا شبكات التواصل الاجتماعي مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط شبكات التواصل الاجتماعي بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};
...
export const header = {
  ...
  subtitle: "تحميل محتوى شبكات التواصل الاجتماعي بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
