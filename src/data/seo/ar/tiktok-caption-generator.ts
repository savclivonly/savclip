export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من تيك توك"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على تيك توك لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "مولد النصوص التوضيحية تيك توك مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط تيك توك بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};

export const header = {
  title: "مولد النصوص التوضيحية",
  title1: "Download",
  title2: "تيك توك التوضيحية",
  title3: "أون لاين مجاناً",
  subtitle: "تحميل محتوى تيك توك بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
