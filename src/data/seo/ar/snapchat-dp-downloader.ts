export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من سناب شات"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على سناب شات لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "تحميل صورة الحساب سناب شات مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط سناب شات بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};

export const header = {
  title: "تحميل صورة الحساب",
  title1: "Download",
  title2: "سناب شات الحساب",
  title3: "أون لاين مجاناً",
  subtitle: "تحميل محتوى سناب شات بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
