export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من فيسبوك"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على فيسبوك لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "أداة تدقيق الصفحات فيسبوك مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط فيسبوك بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};

export const header = {
  title: "أداة تدقيق الصفحات",
  title1: "Download",
  title2: "فيسبوك الصفحات",
  title3: "أون لاين مجاناً",
  subtitle: "تحميل محتوى فيسبوك بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
