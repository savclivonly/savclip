export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل فيديوهات يوتيوب بدون شعارات"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "بدلاً من قص أطراف الفيديو أو وضع تمويه يفسد جودة المظهر، تتصل أداتنا بملف الفيديو الأصلي على خوادم يوتيوب قبل إضافة شعار التطبيق، لنمنحك مقطع فيديو نظيفاً تماماً."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  {
    "q": "كيف يمكنني حفظ فيديوهات يوتيوب بدون علامة مائية؟",
    "a": "انسخ رابط الفيديو من يوتيوب، ثم الصقه في صندوق البحث أعلاه واضغط على زر تحميل. ستقوم الأداة بإزالة العلامة المائية تلقائياً."
  },
  {
...
export const meta = {
  title: "تحميل فيديو يوتيوب مجاناً وبجودة عالية - SavClip",
  description: "حمل فيديوهات وريلز يوتيوب بدون علامة مائية أو شعارات مزعجة. احصل على مقطع فيديو نظيف بصيغة MP4 وبجودة عالية مع الصوت الأصلي."
};
...
export const header = {
  ...
  subtitle: "احفظ فيديوهات يوتيوب بشكل نظيف وبدون أي شعارات مع الاحتفاظ بالصوت الأصلي."
};
