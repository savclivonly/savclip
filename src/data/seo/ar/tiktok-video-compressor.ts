export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل فيديوهات تيك توك بأعلى دقة"
  },
  {
    "type": "paragraph",
    "content": "مع تطور الشاشات الحديثة، أصبحت جودة الفيديو أمراً لا غنى عنه. يتيح لك موقع SavClip تحميل مقاطع الفيديو والريلز من تيك توك بجودتها الأصلية للاستمتاع بكل التفاصيل عند المشاهدة دون اتصال بالإنترنت."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "تقوم العديد من المواقع بضغط الفيديو لتقليل حجمه مما يؤدي لظهور بكسلة بالصورة. أما SavClip فيحصل على الملف الخام مباشرة من خوادم تيك توك ليحافظ على وضوح الألوان والتفاصيل تماماً كما رفعها الناشر الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const faqs = [
  {
    "q": "كيف يمكنني تحميل فيديوهات تيك توك بأعلى دقة متاحة؟",
...
export const meta = {
  title: "ضغط الفيديو تيك توك مجاناً وبجودة عالية - SavClip",
  description: "حمل مقاطع فيديو تيك توك بدقة عالية HD و 4K مجاناً وبأعلى جودة. استمتع بمشاهدة مقاطعك المفضلة بدون إنترنت وبالألوان الأصلية."
};
...
export const header = {
  ...
  subtitle: "قم بتنزيل مقاطع الفيديو والريلز والوسائط من تيك توك بأعلى دقة أصلية وبسرعة فائقة."
};
