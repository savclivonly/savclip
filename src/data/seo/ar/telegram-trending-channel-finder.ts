export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "تنزيل سهل وسريع من تليجرام"
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "content": "نحن لا نعتمد على تسجيل الشاشة أو طرق بديلة تؤثر على الجودة. نقوم بالاتصال المباشر بالبيانات الوصفية للمنشور على تليجرام لنأتيك بالملف الأصلي محتفظاً بكامل ألوانه وجودة صوته الأصلي."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "مكتشف القنوات الرائجة تليجرام مجاناً وبجودة عالية - SavClip",
  description: "أفضل موقع لتحميل وحفظ وسائط تليجرام بجودة عالية. استمتع بتجربة تنزيل سريعة، مستقرة، وآمنة تماماً لحفظ الصور والفيديوهات."
};

export const header = {
  title: "مكتشف القنوات الرائجة",
  title1: "Download",
  title2: "تليجرام الرائجة",
  title3: "أون لاين مجاناً",
  subtitle: "تحميل محتوى تليجرام بدقة HD الأصلية بطريقة بسيطة وسريعة وآمنة."
};
