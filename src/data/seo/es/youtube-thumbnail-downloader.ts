export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "¿Por qué usar SavClip para el Descargador de Miniaturas de YouTube?"
  },
  {
    "type": "paragraph",
    "content": "Nuestra herramienta extrae la imagen directa desde los servidores. Con SavClip puedes guardar fotos de perfil, publicaciones y álbumes carrusel con la nitidez y colores de origen. Si deseas probar otras funciones, también puedes usar nuestro <a href=\"/youtube-playlist-downloader\">Descargador de Listas de Reproducción</a> o consultar el <a href=\"/youtube-subtitle-downloader\">Descargador de Subtítulos</a> para obtener un acceso completo."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "Accedemos al enlace real del archivo de imagen en los servidores de YouTube, lo que garantiza que la foto se conserve tal como fue subida por el creador."
  }
];
