export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Descargador de Historias de Telegram con Anonimato Total"
  },
  {
    "type": "paragraph",
    "content": "Las historias son efímeras y desaparecen después de 24 horas, pero hay momentos e ideas que vale la pena guardar. Nuestro descargador de Telegram te permite guardar fotos y videos en tu dispositivo de forma segura y discreta."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "Evita las capturas o grabaciones de pantalla de baja calidad que estropean la imagen. Nuestra herramienta accede al archivo original en los servidores de Telegram, lo que te permite descargar fotos en JPG y videos en MP4 con su resolución y nitidez originales."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "Guardador de Historias Telegram gratis online - SavClip",
  description: "Descarga historias de Telegram en anónimo. Nuestro visor privado garantiza que el creador nunca sabrá que guardaste sus fotos o videos."
};

export const header = {
  title: "Guardador de Historias",
  title1: "Download",
  title2: "Telegram Historias",
