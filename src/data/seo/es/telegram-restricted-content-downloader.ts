...
export const meta = {
  title: "Descargador de Contenido Restringido Telegram gratis online - SavClip",
...
export const header = {
  title: "Descargador de Contenido Restringido",
  title1: "Download",
  title2: "Telegram Contenido Restringido",
