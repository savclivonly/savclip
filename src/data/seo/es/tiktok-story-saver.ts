export const articleSections = [
  {
    "type": "heading",
    "level": 2,
    "content": "Descargador de Historias de TikTok con Anonimato Total"
  },
  {
    "type": "paragraph",
    "content": "Las historias son efímeras y desaparecen después de 24 horas, pero hay momentos e ideas que vale la pena guardar. Nuestro descargador de TikTok te permite guardar fotos y videos en tu dispositivo de forma segura y discreta."
  },
  {
    "type": "heading",
    "level": 3,
  ...
  {
    "type": "paragraph",
    "content": "Evita las capturas o grabaciones de pantalla de baja calidad que estropean la imagen. Nuestra herramienta accede al archivo original en los servidores de TikTok, lo que te permite descargar fotos en JPG y videos en MP4 con su resolución y nitidez originales."
  },
  {
    "type": "heading",
    "level": 3,
...
export const meta = {
  title: "Guardador de Historias TikTok gratis online - SavClip",
  description: "Descarga historias de TikTok en anónimo. Nuestro visor privado garantiza que el creador nunca sabrá que guardaste sus fotos o videos."
};

export const header = {
  title: "Guardador de Historias",
  title1: "Download",
  title2: "TikTok Historias",
  title3: "Online Gratis",
  subtitle: "Guarda historias, fotos y destacados de TikTok de forma rápida y anónima."
};
